...
export const DaySelector = ({day, workoutName, onPress, isSelected}: RoutineSelectorProps) => {
  return (
    <Pressable className={`bg-surface flex w-[70] p-3 rounded-xl justify-center items-center h-16 border-border border-2 ${isSelected ? 'border-green-100 border-x-2 transform: scale-105' : 'bg-primaryVariant'}`} onPress={onPress}>
