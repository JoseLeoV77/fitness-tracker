...
export function WorkoutCard({id, name, onPress, editPress}: WorkoutCardProp) {
  return (
    <View className='relative'>
      ...
      <Pressable onPress={editPress} className='absolute p-2 bg-white rounded-full top-0.5 right-0.5'>
